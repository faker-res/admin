  ...
  <div>
    <div class="v2-search">
      <Form inline ref="searchKey">
        <FormItem v-if="(adminType == 'super') || (authInPage.indexOf('adminAdd') != -1)" class="origin">
            ...
            render: (h, params) => (
              <div>
                <a
                  class="ib mr15"
                  style={{
                    display: (this.adminType == 'super') || (this.authInPage.indexOf('adminModifyStatus') != -1) ? 'inline-block' : 'none'
                  }}
                  onClick={() => {
                    let postData = {
                      id: params.row.id,
                ...
                <a
                  class="ib mr15"
                  style={{
                    display: this.adminType == "super" || this.authInPage.indexOf("adminUpdate") != -1 ? "inline-block" : "none",
                ...
                <a
                  class="ib mr15"
                  style={{
                    display: (this.adminType == 'super') || (this.authInPage.indexOf('changePassWord') != -1) ? 'inline-block' : "none"
                  }}
                  onClick={() => {
                ...
                <a
                  class="ib mr15"
                  style={{
                    display: (this.adminType == 'super') || (this.authInPage.indexOf('copyAdmin') != -1) ? 'inline-block' : 'none'
                  }}
                  onClick={() => {
